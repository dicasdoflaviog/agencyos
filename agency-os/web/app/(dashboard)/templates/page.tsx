    ...
    <div className="py-8 space-y-8 max-w-5xl mx-auto">
      ...
      {!templates?.length ? (
        <div className="rounded-xl border border-dashed border-zinc-700 p-12 text-center">
          ...
          <Link
            href="/templates/new"
            className="mt-4 inline-flex items-center rounded-lg bg-violet-600 hover:bg-violet-500 px-4 py-2 text-sm font-medium text-white transition-colors"
          >
            ...
            >
              ...
              <div className="flex gap-2 pt-1">
                <Link
                  ...
                  className="flex-1 text-center rounded-lg bg-violet-600 hover:bg-violet-500 px-3 py-1.5 text-xs font-medium text-white transition-colors"
                >
                  Usar template
                </Link>
                <Link
